...
const PAPERS = [
  {
    ...
    links:[
      { label:'View PDF (ResearchGate)', href:'https://www.researchgate.net/profile/Kamal-Pandey-21/publication/389652520_The_Intelligent_Workplace_AI_and_Automation_Shaping_the_Future_of_Digital_Workplaces/links/67cb3262e62c604a0dd61c3d/The-Intelligent-Workplace-AI-and-Automation-Shaping-the-Future-of-Digital-Workplaces.pdf', Icon: ExternalLink },
    ],
  ...
  },
  {
    ...
    links:[
      { label:'Publisher PDF', href:'https://al-kindipublishers.org/index.php/jcsts/article/download/11004/9927', Icon: Download },
      { label:'DOI', href:'https://doi.org/10.32996/jcsts.2025.7.10.33', Icon: ExternalLink },
    ],
  ...
  },
  {
    ...
    citation:'2025',
    links:[
      { label:'Authorea / ESS', href:'https://www.authorea.com/users/942841-dr-kamal-pandey', Icon: ExternalLink },
    ],
  ...
  },
  {
    ...
    links:[
      { label:'TechRxiv PDF', href:'https://www.techrxiv.org/doi/pdf/10.36227/techrxiv.175339236.68743756', Icon: Download },
      { label:'DOI (ResearchGate)', href:'http://dx.doi.org/10.13140/RG.2.2.31644.19846', Icon: ExternalLink },
    ],
  ...
  },
  {
    ...
    links:[
      { label:'IJEASM PDF', href:'https://ijeasm.com/PublishedPaper/5Vol/Issue12/2024IJEASM520243659-ec9380bf-727b-44b1-b267-9a083bceba8957899.pdf', Icon: Download },
      { label:'DOI (ResearchGate)', href:'http://dx.doi.org/10.13140/RG.2.2.32810.32962', Icon: ExternalLink },
    ],
  ...
  },
  {
    ...
    citation:'2025',
    links:[
      { label:'TechRxiv PDF', href:'https://www.techrxiv.org/doi/pdf/10.36227/techrxiv.175339233.38524916', Icon: Download },
    ],
