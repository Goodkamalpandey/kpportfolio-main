    ...
    <section id="work" className="scroll-mt-24 bg-kp-bg py-16 dark:bg-dark-bg md:py-24">
      <div className="mx-auto max-w-content px-5 md:px-8">
        <KpReveal>
          ...
          <p className="mt-4 max-w-3xl text-pretty text-base leading-relaxed text-kp-muted dark:text-kp-line">
            {WORK_VISION.body}
          </p>
        ...
        <div className="mt-14 md:mt-16">
          <KpReveal>
            <p className="font-mono text-caption2 font-semibold uppercase tracking-[0.14em] text-kp-muted dark:text-kp-line">
...
function PortfolioCard({ platform: p }: { platform: Platform }) {
  return (
    <article className="group flex h-full flex-col overflow-hidden rounded-[1.25rem] border border-kp-line/70 bg-white/95 shadow-kp-soft transition duration-300 ease-out-soft hover:-translate-y-0.5 hover:border-kp-accent/30 hover:shadow-kp-elevated dark:border-white/10 dark:bg-dark-card/85 dark:shadow-none dark:hover:border-blue-400/30">
      <div className="flex flex-1 flex-col p-6 md:p-7">
        ...
        <div className="mt-4 flex items-baseline justify-between gap-3">
          ...
          <span className="shrink-0 font-mono text-caption2 text-kp-muted dark:text-kp-line">{p.n}</span>
        </div>
        <p className="mt-1.5 text-sm font-medium leading-snug text-kp-ink/75 dark:text-dark-text/80">{p.tagline}</p>
        <p className="mt-4 text-sm leading-relaxed text-kp-muted dark:text-kp-line">
          <span className="font-semibold text-kp-ink dark:text-dark-text">Problem. </span>
          {p.problem}
        </p>
        <p className="mt-3 text-sm leading-relaxed text-kp-muted dark:text-kp-line">
      ...
      <div className="border-t border-kp-line/60 bg-kp-navy px-6 py-5 text-white dark:border-white/10 dark:bg-[#0a1224] md:px-7">
        <p className="font-mono text-caption2 font-semibold uppercase tracking-[0.12em] text-blue-300/90">
          Design target
        </p>
        ...
        >
          Discuss
          <KpUiIcon name="arrowUpRight" size={14} className="text-blue-300" />
        </Link>
      </div>
    </article>
  )
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <span className="inline-flex items-center gap-1.5 rounded-full border border-kp-line/80 bg-white/80 px-2.5 py-1 font-mono text-caption2 font-semibold uppercase tracking-wider text-kp-muted dark:border-white/10 dark:bg-white/[0.04] dark:text-kp-line">
        <KpUiIcon name={p.icon as KpUiIconName} size={12} className="text-kp-accent dark:text-blue-300" />
        {p.org} · {p.domain}
      </span>
