      ...
      <div className="mx-auto max-w-content px-5 md:px-8">
        <KpReveal>
          ...
          <p className="mt-4 max-w-2xl text-sm leading-relaxed text-white/60 md:text-base">
            Outcome-led practice areas, then the stacks and platforms behind them.
          </p>
        </KpReveal>
          ...
          <div className="mt-8 grid auto-rows-fr gap-5 sm:grid-cols-2 xl:grid-cols-3 xl:gap-6">
            {SKILLS_BLOCKS.map((block) => (
              <KpReveal key={block.title}>
                <article className="flex h-full min-h-0 flex-col overflow-hidden rounded-2xl border border-white/[0.12] bg-white/[0.045] transition duration-200 ease-out-soft motion-safe:hover:-translate-y-0.5 hover:border-kp-accent/40">
                  <div className="flex items-start gap-4 border-b border-white/[0.08] px-5 py-4">
                    <div
                      className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-kp-accent/20 text-kp-accent dark:text-blue-300"
                      aria-hidden
                    >
