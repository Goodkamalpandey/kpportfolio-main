...
export const SITE = {
  ...
  position:
    'Sr Staff AI Architect — Applied & Agentic AI @ Rivian Automotive Inc. · Orange County / Los Angeles, CA',
...
export const HERO_IDENTITY = {
  ...
  roleTitle: 'Sr Staff AI Architect — Applied & Agentic AI',
